...
from datasets.dataset_add_feat_5fold import Vessel_PCNNradiomics_4fold
import numpy as np
import torch
import torch.nn.functional as F
import cv2
from models.pointnet_radiomics import get_model
from data import *
...
if __name__ == '__main__':
    ...
    trainset0 = Vessel_PCNNradiomics_4fold(feature_list=feature_list,phase='train0', category=category, randomseed=randomseed,task = task)
    valset0 = Vessel_PCNNradiomics_4fold(feature_list=feature_list,phase='test0', category=category, randomseed=randomseed,task = task)
    trainset1 = Vessel_PCNNradiomics_4fold(feature_list=feature_list,phase='train1', category=category, randomseed=randomseed,task = task)
    valset1 = Vessel_PCNNradiomics_4fold(feature_list=feature_list,phase='test1', category=category, randomseed=randomseed,task = task)
    trainset2 = Vessel_PCNNradiomics_4fold(feature_list=feature_list,phase='train2', category=category, randomseed=randomseed,task = task)
    valset2 = Vessel_PCNNradiomics_4fold(feature_list=feature_list,phase='test2', category=category, randomseed=randomseed,task = task)
    trainset3 = Vessel_PCNNradiomics_4fold(feature_list=feature_list,phase='train3', category=category, randomseed=randomseed,task = task)
    valset3 = Vessel_PCNNradiomics_4fold(feature_list=feature_list,phase='test3', category=category, randomseed=randomseed,task = task)
    trainset4 = Vessel_PCNNradiomics_4fold(feature_list=feature_list,phase='train4', category=category, randomseed=randomseed,task = task)
    valset4 = Vessel_PCNNradiomics_4fold(feature_list=feature_list,phase='test4', category=category, randomseed=randomseed,task = task)
    testset = Vessel_PCNNradiomics_4fold(feature_list=feature_list,phase='test5', category=category, randomseed=randomseed,task = task)
