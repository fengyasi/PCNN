...
from datasets.dataset import EVARVessel # 5折
import numpy as np
import torch
import torch.nn.functional as F
import cv2
from models.pointnet_CFD import get_model################################
from data import *
...
parser.add_argument('--task', type=str, default="EL", help='task')#########################5折交叉验证
